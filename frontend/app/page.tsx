          ...
          <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
            <div className="text-center mb-10 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground mx-auto mb-10">
                The most intuitive todo application designed to help you
                organize your daily tasks and boost productivity with
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="px-8 py-4 text-base font-bold h-12 rounded-full border-2 border-foreground/20 hover:border-primary/50 text-foreground hover:bg-primary/10 transition-all duration-300 transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-primary/30"
                >
            ...
            <section
              className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16"
            ...
            >
              ...
              <Card
                className="border bg-card shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-primary/10"
                role="region"
              ...
              >
                <CardContent className="p-6 text-center space-y-4">
                  ...
                  <h3
                    id="feature-1"
                    className="text-xl font-bold text-foreground transition-colors duration-300"
                  >
                    Lightning Fast
                  </h3>
                  <p className="text-muted-foreground transition-colors duration-300">
                    Experience blazing fast task management with our optimized
                    interface.
                  </p>
                </CardContent>
              </Card>
              ...
              >
                <CardContent className="p-6 text-center space-y-4">
                  ...
                  <p className="text-muted-foreground transition-colors duration-300">
                    Access your tasks from anywhere, on any device, anytime.
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                with our powerful yet simple todo app.
              </p>
            </div>
          </div>
        </div>
