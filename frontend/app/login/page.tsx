      ...
      <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-background via-primary/5 to-background p-4">
        <div className="w-full max-w-fit">
          <div className="text-center mb-10">
            <div
              className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full text-sm font-medium mb-6 border border-primary/20"
            ...
            <h1
              className="text-3xl font-black bg-linear-to-r from-primary to-accent bg-clip-text"
              role="heading"
              aria-level={1}
            >
