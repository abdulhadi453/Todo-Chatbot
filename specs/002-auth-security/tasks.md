...
- [x] T022 [P] [US1] Create signin form component in frontend/src/components/auth/login-form.tsx
- [x] T023 [P] [US1] Create signup page in frontend/src/pages/signup.tsx
- [x] T024 [P] [US1] Create signin page in frontend/src/pages/login.tsx
